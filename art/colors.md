...
## Хранение данных в изображения и видео
В видео и изображениях часто данные храняться в виде `YCbCr` (яркость, синий и
...
Но цветавые пространства чаще всего определены в рамках `RGB` модели. Поэтому
в при создании изображения или видео, цвет кодируется из `RGB` -> `YCbCr`, а
