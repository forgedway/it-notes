...
- `ICC` профиль - встраеваемый файл в файл изображения, который предоставляет
  математическую модель, переводящую данные цвета из изображения в XYZ модели
  `CIE XYZ` или в LAB модели `CIELAB`. Т.е. переводит цвета из внутренних
  значений изображения в незовисимый от цветового пространства вид.
